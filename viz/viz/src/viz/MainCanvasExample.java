...
import viz.examples.TestRenderToTexture;

public class MainCanvasExample {
    ...
    //private static final String appClass = "viz.TestRenderToTexture";
    ...
    private static void createMenu(){
        ...
        itemKillCanvas.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                TestRenderToTexture trt = new TestRenderToTexture();
                createCanvas2(trt);
                currentPanel.add(canvas, BorderLayout.CENTER);
                frame.pack();
                startApp();
...
//    }
    ...
    public static void createCanvas2(TestRenderToTexture anApp){
        AppSettings settings = new AppSettings(true);
        settings.setWidth(640);
        settings.setHeight(480);
    ...
    public static void main(String[] args){
        ...
        //createCanvas(appClass);
        TestRenderToTexture trtt = new TestRenderToTexture();
        createCanvas2(trtt);
